...
import { FaUsers, FaRegHeart, FaPlay } from "react-icons/fa";
import { IoEyeOutline, IoMdArrowBack } from "react-icons/io";
...
export const MoviePage = () => {
  const { id } = useParams();
  const [value, setValue] = useState(null); // Use null to handle initial loading state
  ...
  // Check if value is null and show loading state
  if (!value) {
